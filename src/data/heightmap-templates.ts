// Heightmap generation templates: each is a script of steps for the heightmap
// generator (tool count height rangeX rangeY per line); probability is the
// relative weight used when picking a random template
