...
window.Markers = (function () {
  ...
  function addEncounter(id, cell) {
    ...
    const legend = `<div>你偶遇了一位人物.下面展示的是镜像网站（严禁登录），</div><a href="https://deorum.vercel.app/encounter/${encounterSeed}" target="_blank" style="color:#deb640;">官方链接</a><iframe src="https://deorum.8desk.top/encounter/${encounterSeed}" width="375" height="600" sandbox="allow-scripts allow-same-origin allow-popups"></iframe>`;
    notes.push({id, name, legend});
  }
